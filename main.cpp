...
{	
	...
	{
		string obj_path = "./Low_Proven1_stt/" + std::to_string(data_min + i) + "/textured_model.obj";							//경로1/3
		...
		string tex_path = "./Low_Proven1_stt/" + std::to_string(data_min + i) + "/textured_model_material0000_map_Kd.png";				//경로2/3
		string tex_path2 = "./Low_Proven1_stt/" + std::to_string(data_min + i) + "/textured_model_material0001_map_Kd.png";				//경로3/3
